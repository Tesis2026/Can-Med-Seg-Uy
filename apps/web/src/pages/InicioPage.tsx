      ...
      <div className={styles.grid}>
        ...
        {hasPermission(permissions, Permission.DashboardRead) ? (
          <ActionCard
            ...
            description="Ver métricas agregadas sobre los reportes aprobados."
          />
        ) : null}
        {hasPermission(permissions, Permission.ExportRead) ? (
          <ActionCard
            to="/exportaciones"
            icon={<IconExportar />}
            title="Exportaciones"
        ...
        {hasPermission(permissions, Permission.PeriodicReportsReceive) ? (
          <ActionCard
            to="/reportes-periodicos"
            icon={<IconPeriodico />}
            title="Reportes periódicos"
            description="Elegir la frecuencia y los gráficos del informe por correo."
          />
        ) : null}
      </div>
    </div>
